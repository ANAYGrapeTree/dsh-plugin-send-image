...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS =
      '[data-send-image-card]{display:flex;flex-direction:column;align-items:flex-start;gap:6px;max-width:100%}'
      + '[data-send-image-card] [data-send-image-thumb]{padding:0;border:none;background:transparent;cursor:zoom-in;text-align:left;border-radius:6px;overflow:hidden;line-height:0}'
      + '[data-send-image-card] [data-send-image-thumb] img{display:block;max-width:100%;max-height:420px;border-radius:6px;object-fit:contain}'
